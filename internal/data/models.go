...
func (u *User) Update() error {
	...
	stmt := `update users set email = $1, 
                 ...
                 updated_at = $4
            where id = $5`
	_, err := db.ExecContext(ctx, stmt, u.Email, u.FirstName, u.LastName, time.Now(), u.ID)
	if err != nil {
		return err
	}
...
// ResetPassword changes the user password
...
// PasswordMatches checks if the given password matches the stored password
